    ...
    <>
      ...
      <div className="shipping">
        <div className="shipping_text">
          ...
          <p>
            All Domestic United States orders include Free Standard Shipping,
            excluding Alaska and Hawaii.
            <br />
            <br />
            We do not currently ship internationally. <br />
            <br />
            Your <span>CURRUS</span> will ship from our U.S. Warehouse within
            24-48 hours* of your payment clearing. We only ship Monday through
            Friday. Any in-stock orders placed Friday through Sunday will ship
