...
export const filterProducts = (
  ...
  dispatch({
    ...
    payload: {
      products: products,
      filteredProducts:
        category !== "" && speed === "" && power === "" && color === ""
          ? products.filter(
              (product) =>
                product.priceUSD > low &&
                product.priceUSD < high &&
                product.category === category,
            )
          : speed !== "" && category === "" && power === "" && color === ""
          ? products.filter(
              (product) =>
                product.priceUSD > low &&
                product.priceUSD < high &&
          ...
          : products.filter(
              (product) => product.priceUSD > low && product.priceUSD < high,
            ),
    },
  });
};
