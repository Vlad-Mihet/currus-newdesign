...
const data = {
  products: [
    ...
    },
    {
      ...
      quantity: 7,
      description:
        "The spirit beast side stand that comes in three different colors.",
      quick: "blah blah blah",
      specification: ["blah blah blah"],
      shipping: "To qualify",
      onSale: false,
    },
    {
      ...
      quantity: 0,
      description:
        "The Smart4u Helmet is made of lightweight yet super strong PC material on the outside. The",
      quick: "blah blah blah",
      specification: ["blah blah blah"],
      shipping: "To qualify",
      onSale: false,
  ...
  blogs: [
    {
      title:
        "Fulfill Your Need for SPeed with the Currus Panther Electric Scooter",
      content:
        "If you think electric scooters are good only for local communiting and cannot offer high speed, think again.",
      date: Date.now(),
      author: "Rachird Farissi",
      tags: ["e-scooter", "post", "accessories"],
    },
  ],
  users: [
    {
